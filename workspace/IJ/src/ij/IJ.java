...
/** Clears the "Results" window and sets the column headings to
	...
	public static void noImage() {
		...
		error("Proteomica Error", "Proteomica Error reported"+"\n"+"Images required to create match-set."); // Altered/changed by Bhushan N K for displaying the error messages for Proteomica
	}
