  ...
  implements ActionListener, ItemListener, WindowListener
{
  ...
  private String[] listDisplay = { "Object/Background binary","Overlaid dams"};
  ...
  //Start : Added by Bhushan N Kharbikar for creating roi of the segments or watershed dams
  private JButton bnSegment = new JButton("Segment");
  //Stop : Added by Bhushan N Kharbikar for creating roi of the segments or watershed dams
...
//    addComponent(pnButtons, 0, 0, 1, 1, 4, this.bnHelp);
    ...
    addComponent(pnButtons, 0, 3, 1, 1, 4, this.bnSegment);
...
//    this.bnSmooth.addActionListener(this);
    ...
    this.bnSegment.addActionListener(this);
...
*/
    ...
    //start : Added by Bhushan N Kharbikar method execute to analyze the particle and determine the ROI and add it to ROi manager 
      else if (e.getSource() == this.bnSegment) { 
  		ParticleAnalyzer pa = new ParticleAnalyzer();
		new PlugInFilterRunner(pa, "Analyze Particles...", "");

      }
    //stop: Added by Bhushan N Kharbikar method execute to analyze the particle and determine the ROI and add it to ROi manager      
    }
    notify();
  }
