  ...
  implements Buffer
{
  ...
  protected FloatBuffer(Image image, int mode)
  {
    ...
    for (int k = 0; k < this.nxy; k++)
      ((float[])this.data[0])[k] = (pixels[k] & 0xFF);
  }
    ...
    case 1:
      ...
      if ((ip instanceof ByteProcessor)) {
        ...
        for (int z = 0; z < this.nz; z++) {
          ...
          for (int k = 0; k < this.nxy; k++) {
            ((float[])this.data[z])[k] = (slice[k] & 0xFF);
          }
        }
      }
        ...
        for (int z = 0; z < this.nz; z++) {
          ...
          for (int k = 0; k < this.nxy; k++) {
            ((float[])this.data[z])[k] = (slice[k] & 0xFFFF);
          }
        }
      }
      ...
      else if ((ip instanceof ColorProcessor))
      {
        for (int z = 0; z < this.nz; z++) {
          ...
          for (int k = 0; k < this.nxy; k++) {
            ...
            double g = (c & 0xFF00) >> 8;
            double b = c & 0xFF;
            ((float[])this.data[z])[k] = ((float)((r + g + b) / 3.0D));
          }
        }
      }
      else {
  ...
  protected FloatBuffer(ImageStack stack, byte channel)
  {
    ...
    else if ((ip instanceof ColorProcessor))
    {
      for (int z = 0; z < this.nz; z++) {
        ...
        case 0:
          for (int k = 0; k < this.nxy; k++) {
            ((float[])this.data[z])[k] = ((pixels[k] & 0xFF0000) >> 16);
          }
          break;
        case 1:
          for (int k = 0; k < this.nxy; k++) {
            ((float[])this.data[z])[k] = ((pixels[k] & 0xFF00) >> 8);
          }
          break;
        case 2:
          for (int k = 0; k < this.nxy; k++) {
            ((float[])this.data[z])[k] = (pixels[k] & 0xFF);
          }
          break;
        default:
          throw_constructor();
  ...
  public void putZ(int x, int y, int z, byte[] buffer)
  {
    try
    {
      ...
      int leni = buffer.length;
      for (int i = 0; i < leni; i++) {
        ((float[])this.data[z])[offset] = (buffer[i] & 0xFF);
        z++;
      }
    }
    catch (Exception e) {
  ...
  public void putZ(int x, int y, int z, short[] buffer)
  {
    try
    {
      ...
      int leni = buffer.length;
      for (int i = 0; i < leni; i++) {
        ((float[])this.data[z])[offset] = (buffer[i] & 0xFFFF);
        z++;
      }
    }
    catch (Exception e) {
  ...
  public void putZ(int x, int y, int z, float[] buffer)
  {
    try
    {
      ...
      int leni = buffer.length;
      for (int i = 0; i < leni; i++) {
        ((float[])this.data[z])[offset] = buffer[i];
        z++;
      }
    }
    catch (Exception e) {
  ...
  public void putZ(int x, int y, int z, double[] buffer)
  {
    try
    {
      ...
      int leni = buffer.length;
      for (int i = 0; i < leni; i++) {
        ((float[])this.data[z])[offset] = ((float)buffer[i]);
        z++;
      }
    }
    catch (Exception e) {
  ...
  public void putXZ(int x, int y, int z, byte[][] buffer)
  {
    try
    {
      ...
      for (int j = 0; j < lenj; z++) {
        offset = x + j * this.nx;
        for (int i = 0; i < leni; offset++) {
          ((float[])this.data[z])[offset] = (buffer[i][j] & 0xFF);
  ...
  public void putXZ(int x, int y, int z, short[][] buffer)
  {
    try
    {
      ...
      for (int j = 0; j < lenj; z++) {
        offset = x + j * this.nx;
        for (int i = 0; i < leni; offset++) {
          ((float[])this.data[z])[offset] = (buffer[i][j] & 0xFFFF);
  ...
  public void putXZ(int x, int y, int z, float[][] buffer)
  {
    try
    {
      ...
      for (int j = 0; j < lenj; z++) {
        offset = x + j * this.nx;
        for (int i = 0; i < leni; offset++) {
          ((float[])this.data[z])[offset] = buffer[i][j];
  ...
  public void putXZ(int x, int y, int z, double[][] buffer)
  {
    try
    {
      ...
      for (int j = 0; j < lenj; z++) {
        offset = x + j * this.nx;
        for (int i = 0; i < leni; offset++) {
          ((float[])this.data[z])[offset] = ((float)buffer[i][j]);
  ...
  public void getZ(int x, int y, int z, byte[] buffer)
  {
    try
    {
      ...
      int leni = buffer.length;
      for (int i = 0; i < leni; i++) {
        buffer[i] = ((byte)(int)((float[])(float[])this.data[z])[offset]);
        z++;
      }
    }
    catch (Exception e) {
  ...
  public void getZ(int x, int y, int z, short[] buffer)
  {
    try
    {
      ...
      int leni = buffer.length;
      for (int i = 0; i < leni; i++) {
        buffer[i] = ((short)(int)((float[])(float[])this.data[z])[offset]);
        z++;
      }
    }
    catch (Exception e) {
  ...
  public void getZ(int x, int y, int z, float[] buffer)
  {
    try
    {
      ...
      int leni = buffer.length;
      for (int i = 0; i < leni; i++) {
        buffer[i] = ((float[])(float[])this.data[z])[offset];
        z++;
      }
    }
    catch (Exception e) {
  ...
  private void allocate()
  {
    try
    {
      ...
      this.nxy = (this.nx * this.ny);
      for (int z = 0; z < this.nz; z++)
        this.data[z] = new float[this.nxy];
    }
    catch (Exception e) {
