  ...
  implements Buffer
{
  ...
  protected ByteBuffer(Image image, int mode)
  {
    ...
    for (int k = 0; k < this.nxy; k++)
      ((byte[])this.data[0])[k] = ((byte)(pixels[k] & 0xFF));
  }
    ...
    case 1:
      ...
      if ((ip instanceof ByteProcessor)) {
        ...
        for (int z = 0; z < this.nz; z++) {
          ...
          for (int k = 0; k < this.nxy; k++) {
            ((byte[])this.data[z])[k] = ((byte)(slice[k] & 0xFF));
          }
        }
      }
        ...
        for (int z = 0; z < this.nz; z++) {
          ...
          for (int k = 0; k < this.nxy; k++) {
            ((byte[])this.data[z])[k] = ((byte)(slice[k] & 0xFFFF));
          }
        }
      }
        ...
        for (int z = 0; z < this.nz; z++) {
          ...
          for (int k = 0; k < this.nxy; k++) {
            ((byte[])this.data[z])[k] = ((byte)(int)slice[k]);
          }
        }
      }
      else if ((ip instanceof ColorProcessor))
      {
        for (int z = 0; z < this.nz; z++) {
          ...
          for (int k = 0; k < this.nxy; k++) {
            ...
            double g = (c & 0xFF00) >> 8;
            double b = c & 0xFF;
            ((byte[])this.data[z])[k] = ((byte)(int)((r + g + b) / 3.0D));
          }
        }
      }
      else {
  ...
  protected ByteBuffer(ImageStack stack, byte channel)
  {
    ...
    else if ((ip instanceof ColorProcessor))
    {
      for (int z = 0; z < this.nz; z++) {
        ...
        case 0:
          for (int k = 0; k < this.nxy; k++) {
            ((byte[])this.data[z])[k] = ((byte)((pixels[k] & 0xFF0000) >> 16));
          }
          break;
        case 1:
          for (int k = 0; k < this.nxy; k++) {
            ((byte[])this.data[z])[k] = ((byte)((pixels[k] & 0xFF00) >> 8));
          }
          break;
        case 2:
          for (int k = 0; k < this.nxy; k++) {
            ((byte[])this.data[z])[k] = ((byte)(pixels[k] & 0xFF));
          }
          break;
        default:
          throw_constructor();
  ...
  public void putZ(int x, int y, int z, byte[] buffer)
  {
    try
    {
      ...
      int leni = buffer.length;
      for (int i = 0; i < leni; i++) {
        ((byte[])this.data[z])[offset] = ((byte)(buffer[i] & 0xFF));
        z++;
      }
    }
    catch (Exception e) {
  ...
  public void putZ(int x, int y, int z, short[] buffer)
  {
    try
    {
      ...
      int leni = buffer.length;
      for (int i = 0; i < leni; i++) {
        ((byte[])this.data[z])[offset] = ((byte)(buffer[i] & 0xFFFF));
        z++;
      }
    }
    catch (Exception e) {
  ...
  public void putZ(int x, int y, int z, float[] buffer)
  {
    try
    {
      ...
      int leni = buffer.length;
      for (int i = 0; i < leni; i++) {
        ((byte[])this.data[z])[offset] = ((byte)(int)buffer[i]);
        z++;
      }
    }
    catch (Exception e) {
  ...
  public void putXZ(int x, int y, int z, byte[][] buffer)
  {
    try
    {
      ...
      for (int j = 0; j < lenj; z++) {
        offset = x + j * this.nx;
        for (int i = 0; i < leni; offset++) {
          ((byte[])this.data[z])[offset] = ((byte)(buffer[i][j] & 0xFF));
  ...
  public void putXZ(int x, int y, int z, short[][] buffer)
  {
    try
    {
      ...
      for (int j = 0; j < lenj; z++) {
        offset = x + j * this.nx;
        for (int i = 0; i < leni; offset++) {
          ((byte[])this.data[z])[offset] = ((byte)(buffer[i][j] & 0xFFFF));
  ...
  public void putXZ(int x, int y, int z, float[][] buffer)
  {
    try
    {
      ...
      for (int j = 0; j < lenj; z++) {
        offset = x + j * this.nx;
        for (int i = 0; i < leni; offset++) {
          ((byte[])this.data[z])[offset] = ((byte)(int)buffer[i][j]);
  ...
  public void getZ(int x, int y, int z, byte[] buffer)
  {
    try
    {
      ...
      int leni = buffer.length;
      for (int i = 0; i < leni; i++) {
        buffer[i] = ((byte)(((byte[])(byte[])this.data[z])[offset] & 0xFF));
        z++;
      }
    }
    catch (Exception e) {
  ...
  public void getZ(int x, int y, int z, short[] buffer)
  {
    try
    {
      ...
      int leni = buffer.length;
      for (int i = 0; i < leni; i++) {
        buffer[i] = ((short)(((byte[])(byte[])this.data[z])[offset] & 0xFF));
        z++;
      }
    }
    catch (Exception e) {
  ...
  public void getZ(int x, int y, int z, float[] buffer)
  {
    try
    {
      ...
      int leni = buffer.length;
      for (int i = 0; i < leni; i++) {
        buffer[i] = (((byte[])(byte[])this.data[z])[offset] & 0xFF);
        z++;
      }
    }
    catch (Exception e) {
