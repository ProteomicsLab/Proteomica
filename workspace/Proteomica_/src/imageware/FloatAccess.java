...
public class FloatAccess extends FloatBuffer
  implements Access
{
  ...
  public double getPixel(int x, int y, int z)
  {
    ...
    if (y < 0) return 0.0D;
    if (z < 0) return 0.0D;
    return ((float[])(float[])this.data[z])[(x + y * this.nx)];
  }
  ...
  public double getPixel(int x, int y, int z, byte boundaryConditions)
  {
    ...
    return ((float[])(float[])this.data[zp])[(xp + yp * this.nx)];
  }
  ...
  public double getInterpolatedPixel(double x, double y, double z)
  {
    ...
    switch (getDimension()) {
    case 1:
      double v1_0 = ((float[])(float[])this.data[k])[index];
      double v1_1 = fi ? v1_0 : ((float[])(float[])this.data[k])[(index + 1)];
      double dx1 = x - i;
      return v1_1 * dx1 - v1_0 * (dx1 - 1.0D);
    case 2:
      double v2_00 = ((float[])(float[])this.data[k])[index];
      double v2_10 = fi ? v2_00 : ((float[])(float[])this.data[k])[(index + 1)];
      double v2_01 = fj ? v2_00 : ((float[])(float[])this.data[k])[(index + this.nx)];
      double v2_11 = fi ? v2_01 : fj ? v2_00 : ((float[])(float[])this.data[k])[(index + 1 + this.nx)];
      double dx2 = x - i;
      double dy2 = y - j;
      return dx2 * (v2_11 * dy2 - v2_10 * (dy2 - 1.0D)) - (dx2 - 1.0D) * (v2_01 * dy2 - v2_00 * (dy2 - 1.0D));
    case 3:
      double v3_000 = ((float[])(float[])this.data[k])[index];
      double v3_100 = fi ? v3_000 : ((float[])(float[])this.data[k])[(index + 1)];
      double v3_010 = fj ? v3_000 : ((float[])(float[])this.data[k])[(index + this.nx)];
      double v3_110 = fi ? v3_010 : fj ? v3_000 : ((float[])(float[])this.data[k])[(index + 1 + this.nx)];
      double v3_001 = fk ? v3_000 : ((float[])(float[])this.data[(k + 1)])[index];
      double v3_011 = fk ? v3_010 : fj ? v3_000 : ((float[])(float[])this.data[(k + 1)])[(index + 1)];
      double v3_101 = fk ? v3_100 : fi ? v3_000 : ((float[])(float[])this.data[(k + 1)])[(index + this.nx)];
      double v3_111 = fk ? v3_110 : fj ? v3_100 : fi ? v3_000 : ((float[])(float[])this.data[(k + 1)])[(index + 1 + this.nx)];
      double dx3 = x - i;
      double dy3 = y - j;
      double dz3 = z - k;
  ...
  public void putPixel(int x, int y, int z, double value)
  {
    ...
    if (y < 0) return;
    if (z < 0) return;
    ((float[])this.data[z])[(x + y * this.nx)] = ((float)value);
  }
  ...
  public void getBoundedZ(int x, int y, int z, byte[] buffer)
  {
    try
    {
      ...
      for (int i = iinf; i < isup; i++) {
        buffer[i] = ((byte)(int)((float[])(float[])this.data[k])[offset]);
        k++;
      }
    }
    catch (Exception e) {
  ...
  public void getBoundedZ(int x, int y, int z, short[] buffer)
  {
    try
    {
      ...
      int isup = z + leni >= this.nz ? this.nz - z : leni;
      for (int i = iinf; i < isup; i++) {
        buffer[i] = ((short)(int)((float[])(float[])this.data[k])[offset]);
        k++;
      }
    }
    catch (Exception e) {
  ...
  public void getBoundedZ(int x, int y, int z, float[] buffer)
  {
    try
    {
      ...
      int isup = z + leni >= this.nz ? this.nz - z : leni;
      for (int i = iinf; i < isup; i++) {
        buffer[i] = ((float[])(float[])this.data[k])[offset];
        k++;
      }
    }
    catch (Exception e) {
  ...
  public void getBoundedXZ(int x, int y, int z, byte[][] buffer)
  {
    try
    {
      ...
      for (int j = jinf; j < jsup; j++) {
        ...
        for (int i = iinf; i < isup; i++) {
          buffer[i][j] = ((byte)(int)((float[])(float[])this.data[z])[offset]);
          offset++;
        }
        k++;
      }
  ...
  public void getBoundedXZ(int x, int y, int z, short[][] buffer)
  {
    try
    {
      ...
      for (int j = jinf; j < jsup; j++) {
        offset = x + iinf + y * this.nx;
        for (int i = iinf; i < isup; i++) {
          buffer[i][j] = ((short)(int)((float[])(float[])this.data[z])[offset]);
          offset++;
        }
        k++;
      }
  ...
  public void getBoundedXZ(int x, int y, int z, float[][] buffer)
  {
    try
    {
      ...
      for (int j = jinf; j < jsup; j++) {
        offset = x + iinf + y * this.nx;
        for (int i = iinf; i < isup; i++) {
          buffer[i][j] = ((float[])(float[])this.data[z])[offset];
          offset++;
        }
        k++;
      }
  ...
  public void getBlockZ(int x, int y, int z, byte[] buffer, byte boundaryConditions)
  {
    ...
    try
    {
      ...
      for (int i = 0; i < leni; i++) {
        ...
        buffer[i] = ((byte)(int)((float[])(float[])this.data[zp])[xyp]);
      }
    }
    catch (Exception e) {
      throw_get("Z", "Mirror or periodic boundaray conditions", buffer, x, y, z);
  ...
  public void getBlockZ(int x, int y, int z, short[] buffer, byte boundaryConditions)
  {
    ...
    try
    {
      ...
      for (int i = 0; i < leni; i++) {
        ...
        buffer[i] = ((short)(int)((float[])(float[])this.data[zp])[xyp]);
      }
    }
    catch (Exception e) {
      throw_get("Z", "Mirror or periodic boundaray conditions", buffer, x, y, z);
  ...
  public void getBlockZ(int x, int y, int z, float[] buffer, byte boundaryConditions)
  {
    ...
    try
    {
      ...
      for (int i = 0; i < leni; i++) {
        ...
        buffer[i] = ((float[])(float[])this.data[zp])[xyp];
      }
    }
    catch (Exception e) {
      throw_get("Z", "Mirror or periodic boundaray conditions", buffer, x, y, z);
    ...
    try
    {
      ...
      for (int j = 0; j < lenj; j++) {
        ...
        for (int i = 0; i < leni; i++) {
          ...
          buffer[i][j] = ((byte)(int)((float[])(float[])this.data[zp])[(xp + yp)]);
        }
      }
    }
    catch (Exception e) {
    ...
    try
    {
      ...
      for (int j = 0; j < lenj; j++) {
        ...
        for (int i = 0; i < leni; i++) {
          ...
          buffer[i][j] = ((short)(int)((float[])(float[])this.data[zp])[(xp + yp)]);
        }
      }
    }
    catch (Exception e) {
    ...
    try
    {
      ...
      for (int j = 0; j < lenj; j++) {
        ...
        for (int i = 0; i < leni; i++) {
          ...
          buffer[i][j] = ((float[])(float[])this.data[zp])[(xp + yp)];
        }
      }
    }
    catch (Exception e) {
    ...
    try
    {
      ...
      for (int j = 0; j < lenj; j++) {
        ...
        for (int i = 0; i < leni; i++) {
          ...
          buffer[i][j] = ((byte)(int)((float[])(float[])this.data[zp])[(xp + yp * this.nx)]);
        }
      }
    }
    catch (Exception e) {
    ...
    try
    {
      ...
      for (int j = 0; j < lenj; j++) {
        ...
        for (int i = 0; i < leni; i++) {
          ...
          buffer[i][j] = ((short)(int)((float[])(float[])this.data[zp])[(xp + yp * this.nx)]);
        }
      }
    }
    catch (Exception e) {
    ...
    try
    {
      ...
      for (int j = 0; j < lenj; j++) {
        ...
        for (int i = 0; i < leni; i++) {
          ...
          buffer[i][j] = ((float[])(float[])this.data[zp])[(xp + yp * this.nx)];
        }
      }
    }
    catch (Exception e) {
  ...
  public void putBoundedZ(int x, int y, int z, byte[] buffer)
  {
    try
    {
      ...
      int isup = z + leni >= this.nz ? this.nz - z : leni;
      for (int i = iinf; i < isup; i++) {
        ((float[])this.data[k])[offset] = (buffer[i] & 0xFF);
        k++;
      }
    }
    catch (Exception e) {
  ...
  public void putBoundedZ(int x, int y, int z, short[] buffer)
  {
    try
    {
      ...
      int isup = z + leni >= this.nz ? this.nz - z : leni;
      for (int i = iinf; i < isup; i++) {
        ((float[])this.data[k])[offset] = (buffer[i] & 0xFFFF);
        k++;
      }
    }
    catch (Exception e) {
  ...
  public void putBoundedZ(int x, int y, int z, float[] buffer)
  {
    try
    {
      ...
      int isup = z + leni >= this.nz ? this.nz - z : leni;
      for (int i = iinf; i < isup; i++) {
        ((float[])this.data[k])[offset] = buffer[i];
        k++;
      }
    }
    catch (Exception e) {
  ...
  public void putBoundedZ(int x, int y, int z, double[] buffer)
  {
    try
    {
      ...
      int isup = z + leni >= this.nz ? this.nz - z : leni;
      for (int i = iinf; i < isup; i++) {
        ((float[])this.data[k])[offset] = ((float)buffer[i]);
        k++;
      }
    }
    catch (Exception e) {
  ...
  public void putBoundedXZ(int x, int y, int z, byte[][] buffer)
  {
    try
    {
      ...
      for (int j = jinf; j < jsup; j++) {
        offset = x + iinf + y * this.nx;
        for (int i = iinf; i < isup; i++) {
          ((float[])this.data[k])[offset] = (buffer[i][j] & 0xFF);
          offset++;
        }
        k++;
      }
  ...
  public void putBoundedXZ(int x, int y, int z, short[][] buffer)
  {
    try
    {
      ...
      for (int j = jinf; j < jsup; j++) {
        offset = x + iinf + y * this.nx;
        for (int i = iinf; i < isup; i++) {
          ((float[])this.data[k])[offset] = (buffer[i][j] & 0xFFFF);
          offset++;
        }
        k++;
      }
  ...
  public void putBoundedXZ(int x, int y, int z, float[][] buffer)
  {
    try
    {
      ...
      for (int j = jinf; j < jsup; j++) {
        offset = x + iinf + y * this.nx;
        for (int i = iinf; i < isup; i++) {
          ((float[])this.data[k])[offset] = buffer[i][j];
          offset++;
        }
        k++;
      }
  ...
  public void putBoundedXZ(int x, int y, int z, double[][] buffer)
  {
    try
    {
      ...
      for (int j = jinf; j < jsup; j++) {
        offset = x + iinf + y * this.nx;
        for (int i = iinf; i < isup; i++) {
          ((float[])this.data[k])[offset] = ((float)buffer[i][j]);
          offset++;
        }
        k++;
      }
