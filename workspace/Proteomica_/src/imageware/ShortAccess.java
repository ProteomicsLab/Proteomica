  ...
  implements Access
{
  ...
  public double getPixel(int x, int y, int z)
  {
    ...
    if (y < 0) return 0.0D;
    if (z < 0) return 0.0D;
    return ((short[])(short[])this.data[z])[(x + y * this.nx)] & 0xFFFF;
  }
  ...
  public double getPixel(int x, int y, int z, byte boundaryConditions)
  {
    ...
    return ((short[])(short[])this.data[zp])[(xp + yp * this.nx)] & 0xFFFF;
  }
  ...
  public double getInterpolatedPixel(double x, double y, double z)
  {
    ...
    switch (getDimension()) {
    case 1:
      double v1_0 = ((short[])(short[])this.data[k])[index] & 0xFFFF;
      double v1_1 = fi ? v1_0 : ((short[])(short[])this.data[k])[(index + 1)] & 0xFFFF;
      double dx1 = x - i;
      return v1_1 * dx1 - v1_0 * (dx1 - 1.0D);
    case 2:
      double v2_00 = ((short[])(short[])this.data[k])[index] & 0xFFFF;
      double v2_10 = fi ? v2_00 : ((short[])(short[])this.data[k])[(index + 1)] & 0xFFFF;
      double v2_01 = fj ? v2_00 : ((short[])(short[])this.data[k])[(index + this.nx)] & 0xFFFF;
      double v2_11 = fi ? v2_01 : fj ? v2_00 : ((short[])(short[])this.data[k])[(index + 1 + this.nx)] & 0xFFFF;
      double dx2 = x - i;
      double dy2 = y - j;
      return dx2 * (v2_11 * dy2 - v2_10 * (dy2 - 1.0D)) - (dx2 - 1.0D) * (v2_01 * dy2 - v2_00 * (dy2 - 1.0D));
    case 3:
      double v3_000 = ((short[])(short[])this.data[k])[index] & 0xFFFF;
      double v3_100 = fi ? v3_000 : ((short[])(short[])this.data[k])[(index + 1)] & 0xFFFF;
      double v3_010 = fj ? v3_000 : ((short[])(short[])this.data[k])[(index + this.nx)] & 0xFFFF;
      double v3_110 = fi ? v3_010 : fj ? v3_000 : ((short[])(short[])this.data[k])[(index + 1 + this.nx)] & 0xFFFF;
      double v3_001 = fk ? v3_000 : ((short[])(short[])this.data[(k + 1)])[index] & 0xFFFF;
      double v3_011 = fk ? v3_010 : fj ? v3_000 : ((short[])(short[])this.data[(k + 1)])[(index + 1)] & 0xFFFF;
      double v3_101 = fk ? v3_100 : fi ? v3_000 : ((short[])(short[])this.data[(k + 1)])[(index + this.nx)] & 0xFFFF;
      double v3_111 = fk ? v3_110 : fj ? v3_100 : fi ? v3_000 : ((short[])(short[])this.data[(k + 1)])[(index + 1 + this.nx)] & 0xFFFF;
      double dx3 = x - i;
      double dy3 = y - j;
      double dz3 = z - k;
  ...
  public void putPixel(int x, int y, int z, double value)
  {
    ...
    if (y < 0) return;
    if (z < 0) return;
    ((short[])this.data[z])[(x + y * this.nx)] = ((short)(int)value);
  }
  ...
  public void getBoundedZ(int x, int y, int z, byte[] buffer)
  {
    try
    {
      ...
      for (int i = iinf; i < isup; i++) {
        buffer[i] = ((byte)(((short[])(short[])this.data[k])[offset] & 0xFFFF));
        k++;
      }
    }
    catch (Exception e) {
  ...
  public void getBoundedZ(int x, int y, int z, short[] buffer)
  {
    try
    {
      ...
      int isup = z + leni >= this.nz ? this.nz - z : leni;
      for (int i = iinf; i < isup; i++) {
        buffer[i] = ((short)(((short[])(short[])this.data[k])[offset] & 0xFFFF));
        k++;
      }
    }
    catch (Exception e) {
  ...
  public void getBoundedZ(int x, int y, int z, float[] buffer)
  {
    try
    {
      ...
      int isup = z + leni >= this.nz ? this.nz - z : leni;
      for (int i = iinf; i < isup; i++) {
        buffer[i] = (((short[])(short[])this.data[k])[offset] & 0xFFFF);
        k++;
      }
    }
    catch (Exception e) {
  ...
  public void getBlockY(int x, int y, int z, byte[] buffer, byte boundaryConditions)
  {
    ...
    try
    {
      ...
      for (int i = 0; i < leni; i++) {
        ...
        buffer[i] = ((byte)(tmp[(xp + yp * this.nx)] & 0xFFFF));
      }
    }
    catch (Exception e) {
      throw_get("Y", "Mirror or periodic boundaray conditions", buffer, x, y, z);
  ...
  public void getBlockY(int x, int y, int z, short[] buffer, byte boundaryConditions)
  {
    ...
    try
    {
      ...
      for (int i = 0; i < leni; i++) {
        ...
        buffer[i] = ((short)(tmp[(xp + yp * this.nx)] & 0xFFFF));
      }
    }
    catch (Exception e) {
      throw_get("Y", "Mirror or periodic boundaray conditions", buffer, x, y, z);
  ...
  public void getBlockY(int x, int y, int z, float[] buffer, byte boundaryConditions)
  {
    ...
    try
    {
      ...
      for (int i = 0; i < leni; i++) {
        ...
        buffer[i] = (tmp[(xp + yp * this.nx)] & 0xFFFF);
      }
    }
    catch (Exception e) {
      throw_get("Y", "Mirror or periodic boundaray conditions", buffer, x, y, z);
  ...
  public void getBlockZ(int x, int y, int z, byte[] buffer, byte boundaryConditions)
  {
    ...
    try
    {
      ...
      for (int i = 0; i < leni; i++) {
        ...
        buffer[i] = ((byte)(((short[])(short[])this.data[zp])[xyp] & 0xFFFF));
      }
    }
    catch (Exception e) {
      throw_get("Z", "Mirror or periodic boundaray conditions", buffer, x, y, z);
  ...
  public void getBlockZ(int x, int y, int z, short[] buffer, byte boundaryConditions)
  {
    ...
    try
    {
      ...
      for (int i = 0; i < leni; i++) {
        ...
        buffer[i] = ((short)(((short[])(short[])this.data[zp])[xyp] & 0xFFFF));
      }
    }
    catch (Exception e) {
      throw_get("Z", "Mirror or periodic boundaray conditions", buffer, x, y, z);
  ...
  public void getBlockZ(int x, int y, int z, float[] buffer, byte boundaryConditions)
  {
    ...
    try
    {
      ...
      for (int i = 0; i < leni; i++) {
        ...
        buffer[i] = (((short[])(short[])this.data[zp])[xyp] & 0xFFFF);
      }
    }
    catch (Exception e) {
      throw_get("Z", "Mirror or periodic boundaray conditions", buffer, x, y, z);
    ...
    try
    {
      ...
      for (int j = 0; j < lenj; j++) {
        ...
        for (int i = 0; i < leni; i++) {
          ...
          buffer[i][j] = ((byte)(((short[])(short[])this.data[zp])[(xp + yp)] & 0xFFFF));
        }
      }
    }
    catch (Exception e) {
    ...
    try
    {
      ...
      for (int j = 0; j < lenj; j++) {
        ...
        for (int i = 0; i < leni; i++) {
          ...
          buffer[i][j] = ((short)(((short[])(short[])this.data[zp])[(xp + yp)] & 0xFFFF));
        }
      }
    }
    catch (Exception e) {
    ...
    try
    {
      ...
      for (int j = 0; j < lenj; j++) {
        ...
        for (int i = 0; i < leni; i++) {
          ...
          buffer[i][j] = (((short[])(short[])this.data[zp])[(xp + yp)] & 0xFFFF);
        }
      }
    }
    catch (Exception e) {
    ...
    try
    {
      ...
      for (int j = 0; j < lenj; j++) {
        ...
        for (int i = 0; i < leni; i++) {
          ...
          buffer[i][j] = ((byte)(((short[])(short[])this.data[zp])[(xp + yp * this.nx)] & 0xFFFF));
        }
      }
    }
    catch (Exception e) {
    ...
    try
    {
      ...
      for (int j = 0; j < lenj; j++) {
        ...
        for (int i = 0; i < leni; i++) {
          ...
          buffer[i][j] = ((short)(((short[])(short[])this.data[zp])[(xp + yp * this.nx)] & 0xFFFF));
        }
      }
    }
    catch (Exception e) {
    ...
    try
    {
      ...
      for (int j = 0; j < lenj; j++) {
        ...
        for (int i = 0; i < leni; i++) {
          ...
          buffer[i][j] = (((short[])(short[])this.data[zp])[(xp + yp * this.nx)] & 0xFFFF);
        }
      }
    }
    catch (Exception e) {
  ...
  public void putBoundedZ(int x, int y, int z, byte[] buffer)
  {
    try
    {
      ...
      int isup = z + leni >= this.nz ? this.nz - z : leni;
      for (int i = iinf; i < isup; i++) {
        ((short[])this.data[k])[offset] = ((short)(buffer[i] & 0xFF));
        k++;
      }
    }
    catch (Exception e) {
  ...
  public void putBoundedZ(int x, int y, int z, short[] buffer)
  {
    try
    {
      ...
      int isup = z + leni >= this.nz ? this.nz - z : leni;
      for (int i = iinf; i < isup; i++) {
        ((short[])this.data[k])[offset] = ((short)(buffer[i] & 0xFFFF));
        k++;
      }
    }
    catch (Exception e) {
  ...
  public void putBoundedZ(int x, int y, int z, float[] buffer)
  {
    try
    {
      ...
      int isup = z + leni >= this.nz ? this.nz - z : leni;
      for (int i = iinf; i < isup; i++) {
        ((short[])this.data[k])[offset] = ((short)(int)buffer[i]);
        k++;
      }
    }
    catch (Exception e) {
  ...
  public void putBoundedXZ(int x, int y, int z, byte[][] buffer)
  {
    try
    {
      ...
      for (int j = jinf; j < jsup; j++) {
        offset = x + iinf + y * this.nx;
        for (int i = iinf; i < isup; i++) {
          ((short[])this.data[k])[offset] = ((short)(buffer[i][j] & 0xFF));
          offset++;
        }
        k++;
      }
  ...
  public void putBoundedXZ(int x, int y, int z, short[][] buffer)
  {
    try
    {
      ...
      for (int j = jinf; j < jsup; j++) {
        offset = x + iinf + y * this.nx;
        for (int i = iinf; i < isup; i++) {
          ((short[])this.data[k])[offset] = ((short)(buffer[i][j] & 0xFFFF));
          offset++;
        }
        k++;
      }
  ...
  public void putBoundedXZ(int x, int y, int z, float[][] buffer)
  {
    try
    {
      ...
      for (int j = jinf; j < jsup; j++) {
        offset = x + iinf + y * this.nx;
        for (int i = iinf; i < isup; i++) {
          ((short[])this.data[k])[offset] = ((short)(int)buffer[i][j]);
          offset++;
        }
        k++;
      }
