...
public class Interactive_Surface_Plot implements PlugIn, MouseListener, MouseMotionListener, ItemListener{
	...
	public static void main(String args[]) {
		Interactive_Surface_Plot sp = new Interactive_Surface_Plot();
...
////		sp.image.updateAndDraw();
	...
	public void run(String arg) {
		...
		if (image!=null) {
			...
			IJ.error("Requires image to be opened");
			return;
			//generateSampleImage();
		}
