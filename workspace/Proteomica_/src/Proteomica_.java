...
class ProteinProfiler extends JFrame implements  ActionListener, WindowListener, ItemListener{
	...
	public void setup() {
		...
		bnOpenMatchSet.setToolTipText("Click to open image in order to create match set");
		...
		bnAutoPreProcess.setToolTipText("Remove noises, background, artifacts from gel images");
		...
		bnAutoWarp.setToolTipText("Set image with minimum geometric distortion as as target(reference)image");
		...
		bnMeanParentGel.setToolTipText("Create Global mean gel using pre-processed gel images");
		...
		bnAutoSegment.setToolTipText("Detect protein spots");
		...
		bnSpotManager.setToolTipText("Save detected spot or Load saved spots and other miscellaneous operations");
		...
		bnAutoQuantify.setToolTipText("Measure the Protein volume across multiple gels");
		
		bnGenerateStats = new JButton("Statistics");// button for generating statistics of all  
		bnGenerateStats.addActionListener(this);
		bnGenerateStats.setToolTipText("Display result table with measured parameters and basics statistics");
		
		bn3DView = new JButton("3D View");
		bn3DView.addActionListener(this);
		bn3DView.setToolTipText("Generate 3D surface plots");
		
		bnSpotProfile = new JButton("Profile Plots");
		bnSpotProfile.addActionListener(this);
		bnSpotProfile.setToolTipText("Plot one dimensional protein profile plot as peaks");
		
		bnExit = new JButton("Exit");
		bnExit.addActionListener(this);
		bnExit.setToolTipText("Thanks for using Proteomica");
		
		bnHelp = new JButton("Help");
		bnHelp.addActionListener(this);
		bnHelp.setToolTipText("Our Gratitute towards all the Researchers whose work (directly / indirectly) has been used to build the complete 2DE gel analysis suite as opensource.");
