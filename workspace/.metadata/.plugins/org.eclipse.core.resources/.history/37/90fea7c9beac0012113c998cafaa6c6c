...
public class WarpedOutputWriter implements PlugIn {

	//private static String defaultDirectory = null;
	//private static String[] choices = {"BMP",  "FITS", "GIF", "JPEG", "PGM", "PNG", "Raw", "Text", "TIFF",  "ZIP"};
	private static String choices = "JPEG";
	...
	public void run(String arg) {
		...
		GenericDialog gd = new GenericDialog("Generating Aligned image");
		
		//start : Commented by Bhushan N Kharbikar not willing to provide choice for image format as JPEG format is 
		//found to be more suitable for the application   
//		gd.addChoice("Format:", choices, fileType);
		//stop : Commented by Bhushan N Kharbikar
...
*/			useLabels = false;
		...
		//start : file operations for saving the warped images
		
		// start : commented by Bhushan N Kharbikar as only we have to save the the first image from the stack which is the transformed image
	...
	//for (int i=1; i<=nSlices; i++) {  
		...
		//} // stop : commented by Bhushan N Kharbikar as only we have to save the the first image from the stack which is the transformed image
		imp.unlock();
